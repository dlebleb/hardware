...
def init_environment():
    ...
    # ROS frame, metre. [x_min, y_min, w(x-yon), h(y-yon)]
    # rect_obstacles = [
    #     [0.0,   2.25, 0.3, 0.3],   # obs1 kup
    #     [0.45, -1.0,  0.6, 0.3],   # obs2 uzun +x
    #     [2.65, -0.8,  0.3, 0.6],   # obs3 uzun +y
    #     [2.6,   2.2,  0.3, 0.6],   # obs4 uzun +y
    #    #[-0.15, 3.0,  0.3, 0.3],   # obs5 kup
    # ]

#DRONE CAGE
#     rect_obstacles = [
#     [0.294,  0.8, 0.3, 0.3],   # obs1: y = 0.892 - 0.3 = 0.592
#     [0.51,  -1.477, 0.6, 0.3],   # obs2: y = -1.177 - 0.3 = -1.477
#     [2.714, -1.534, 0.3, 0.6],   # obs3: y = -0.934 - 0.6 = -1.534
#     #[2.724,  1.85, 0.3, 0.6],   # obs4: y = 2.075 - 0.6 = 1.475
#     [2.567, 2.216, 0.3, 0.3],    # obs4 kup
# ]
    
#OUTSIDE DRONE CAGE
    rect_obstacles = [
    [0,  2.0, 0.3, 0.3],     # obs1: y = 0.892 - 0.3 = 0.592
    [0.5,  -1.0, 0.6, 0.3],   # obs2: y = -1.177 - 0.3 = -1.477
    [2.7, -1.5, 0.3, 0.6],   # obs3: y = -0.934 - 0.6 = -1.534
    #[2.724,  1.85, 0.3, 0.6],   # obs4: y = 2.075 - 0.6 = 1.475
    [2.5, 2.0, 0.3, 0.6],    # obs4 kup
]
    ...
    buffer = 0.45   # olctugun genisletilmis rect (45 cm)
    expanded_rects = []
    for x, y, w, h in rect_obstacles:
        expanded_rects.append([x-buffer, y-buffer, w+2*buffer, h+2*buffer])
    eps = 0.001
    eps_expanded_rects = []
    for x, y, w, h in rect_obstacles:
        eps_expanded_rects.append([x-buffer+eps, y-buffer+eps,
                                   w+2*buffer-2*eps, h+2*buffer-2*eps])
...
def compute_expanded_rects(rect_obstacles, buffer=0.45): #buffer = 1.0
    """
